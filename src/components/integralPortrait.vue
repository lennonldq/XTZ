  ...
  <el-main class="integralWarp">
      ...
      <div class="talentLabel">
        ...
        <div class="btnBox">
          <router-link tag="button"
                       :to="{path:'/portrait/compositePortrait',query:{classId:$route.query.classId,userId:$route.query.userId}}">综合画像</router-link>
        </div>
        <div class="labelBox">
          <span>人才标签:</span>
          <div class="labelList">
            <p :class="item.className"
               v-for="item in personalCharacterArr"
               :key="item.id">{{ item.talentLabelName }}</p>
          </div>
        </div>
      </div>
      <div class="scoreBox"
        ...
        <div class="btnDiv">
          <router-link tag="button"
                       :to="{path:'portrait/coursePortrait',query:$route.query}">查看课程画像</router-link>
        </div>
        <div class="scoreItem"
          ...
          <button class="btn"
                  @click="linkTo(item.moduleName)">查看{{ item.moduleName  }}画像</button>
          <div class="scoreMain">
            <div class="score">
    ...
    <div class="statisticsWarp">
      <div class="statistics_title">
        ...
        <div class="time">
          <label>时间：</label>
          <el-date-picker v-model="timeArrange"
                          type="daterange"
...
export default {
  ...
  methods: {
    ...
    getintegralPortraitData() {
      ...
      this.$ajax
        .get(this.baseUrl + integralPortrait, {
