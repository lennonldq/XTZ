  ...
  <div class="main">
    ...
    <div class="module">
      ...
      <div class="taskShow">
          ...
          <div class="gradeAly" style="left:470px">
    ...
    <div class="module">
      ...
      <p class="scoreResult">本平台根据逻辑思维能力、人际交流能力、领导组织能力、适应调整能力、解决问题能力、创新想象能力、学习总结能力、信息收集能力等八项软
        ...
        <div class="abilityChart" ref="abilityChart"></div>
    </div>
    <div class="module" style="margin-bottom: 0">
      <div class="title">
        课程得分
        <div class="tab">
           <p v-for="item,index in tab" :class="{'active':inx === index}" @click="tabChange(index,item.termnum)">{{ item.title }}</p>
        </div>
      </div>
      <div class="tabWarp">
        <p class="noData" v-if="courseData.length == 0&& !loading"> 暂无数据！ </p>
        <div class="echartBox">
           <div class="echartCon"  v-loading="loading" element-loading-text="拼命加载中">
               <div class="echatWarp" v-for="item,index in courseData">
                   <div class="chartTiT">
                   ...
                   <div class="chartRender" :class="item.courseid == courseid?'show':''">
                       <!--课程雷达图-->
                       <div class="kcldtChart" :id="'kcldtChart'+item.courseid"></div>
                       <!--课程折现图-->
                       <div class="kczxtChart" :id="'kczxtChart'+item.courseid"></div>
                   </div>
               </div>
            </div>
       </div>
