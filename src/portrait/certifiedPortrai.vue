<template>
  <div class="main">
    ...
    <div class="module">
      ...
      <div class="situtationChart"
           ref="situtationChart"></div>
    </div>
...
export default {
  ...
  methods: {
    ...
    situtationEchart(termid, countNo, name) {
      //认证情况
    ...
    getCertificationData() {
      ...
      this.$ajax
        .get(this.baseUrl + certification, {
          params: {
            userId,
            classId,
          },
    ...
    getCertificationSituationData() {
      //获取认证情况数据
      let { userId, classId } = this.$route.query;
      this.$ajax
        .get(this.baseUrl + certificationSituation, {
          params: {
            userId,
            classId,
          },
